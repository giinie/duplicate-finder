...
import finder.ui.heatmap.heatMap
import java.awt.*
import javax.swing.*
...
class TextSearchDialog(
    ...
    private fun refresh() {
        ...
        queryPane.document = heatMap(searchChunk, results, options)
...
private fun JTextPane.resetStyleOnFocus() = addFocusListener(object : java.awt.event.FocusListener {
